const Hero = () => {
  return (
    <div className="relative bg-bg-img-mountain bg-cover bg-center h-[600px] m-5 rounded-3xl">
      <div className="absolute inset-0 bg-black bg-opacity-60 rounded-3xl flex items-start justify-start">
        <div className="p-24">
          <h1 className="text-orange-400 text-6xl font-bold">
          ...
          <button className="mt-10 text-lg text-black font-bold bg-orange-500 hover:scale-125 duration-500 px-5 py-2 rounded-full font-lora ">
            Book Now
          </button>
